...
export default function Project() {
  return (
    <main className={styles.main}>
      ...
      <Link className="button" href="https://github.com/erikhai/My-portfolio-progress" target="_blank"><Image width={100} height={100} src="/github-mark.png" alt="Project" /></Link>
